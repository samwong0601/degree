...
def main():
    ...
    directory = sys.argv[1] if len(sys.argv) == 2 else f"{sys.path[0]}/large"
...
def shortest_path(source, target):
    ...
    frontier.add(start)
    # Initialize the explored set with the source node
    explored = set()
    ...
    while frontier.empty() is not True:
        ...
        for movie_id, neighbor in neighbors_for_person(node.state):
